...
/**
 * Clase para contener al m�todo main y testear la jerarqu�a de clases de cuentas bancarias, usando polimorfismo
 * 
...
public class Principal
{
    public static void main(String args[])
    {
       ...
       b.setNumero(5);
       //b.actualizar();   // no compila: el m�todo no est� en la base.
       Inversion x = (Inversion) b;  // hacemos casting para no confundir al compilador
       x.actualizar();  // ahora s�...
       b.retirar(3000);  
       
       c.setNumero(6);
       //c.actualizar();  // no compila: no est� en la base, ni definido en Corriente. Ac� no hay casting que valga!!!
       c.retirar(2000); 
       ...
       Cuenta v[] = new Cuenta[4];  // un arreglo de referencias polim�rficas. Puede representar la cartera de clientes del banco
       ...
       for(i=0; i<4; i++)
       {
          if(v[i] instanceof Inversion)
          {
             ...
             inv.actualizar();  //actualizar() est� definido s�lo en la clase Inversion 
         }
       }
       ...
       // y ahora queremos mostrar s�lo los que son de la misma clase que �l... con instanceof no podemos!!
       for(i=0; i<4; i++)
       {
