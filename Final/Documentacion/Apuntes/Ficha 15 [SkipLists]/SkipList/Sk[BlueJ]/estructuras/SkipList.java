...
public class SkipList
{
      ...
      public void clear()
      {
        for(int i = 0; i <= MAX_LEVEL; i++) frente.setNext(null, i);
        cantidad = 0;
        level = 0;
      }
      ...
      {
        if( ! isHomogeneus(data) ) return null;
      ...
      private boolean isHomogeneus(Comparable x)
      {
        ...
        if ( frente.getInfo() != null && x.getClass() != frente.getInfo().getClass() ) return false;
        return true;
      }
      ...
      private int randomLevel()
      {
        ...
        if(newLevel < MAX_LEVEL) return newLevel;
        return MAX_LEVEL;
      }
}
