/**
 * Una ventana creada con componentes del paquete swing, usada como ventana de arranque en una aplicación que carga 
 * datos en un objeto de la clase Listado. Incluimos ahora un menú de opciones como complemento a los botones.
 * 
...
public class VentanaInicial extends JFrame
{
    ...
    public VentanaInicial()
    {
        ...
        barra = new JMenuBar();
        this.setJMenuBar(barra);  // indicamos que el frame debe activar el menú... 
        ...
        file.add(about);
        file.addSeparator(); // una línea separadora horizontal...
        file.add(salir);
