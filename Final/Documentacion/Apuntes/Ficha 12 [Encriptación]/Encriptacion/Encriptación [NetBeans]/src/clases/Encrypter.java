...
public abstract class Encrypter
{
     ...
     */
    public static final String ALFABETO = " ABCDEFGHIJKLMN�OPQRSTUVWXYZabcdefghijklmn�opqrstuvwxyz.,;:?!0123456789";
    ...
    /**
     * Retorna el �ltimo mensaje encriptado. Si el valor retornado es null, es que la �ltima invocaci�n a code() 
     * no pudo completar el proceso (posiblemente por caracteres extra�os en el mensaje abierto). Si el valor retornado
     * es la cadena vac�a (""), es que nunca se invoc� code() o bien es que el mensaje abierto fue cambiado (con 
     * setOpenMessage()) desde la �ltima vez que se invoc� a code().
     * @return el �ltimo mensaje encriptado.
     */
    ...
    /**
     *  Retorna una cadena con el �ltimo mensaje abierto trabajado por el encriptador y la �ltima encriptaci�n
    ...
    {
        return "Ultimo mensaje abierto: " + mensaje + "  -  Ultima encriptaci�n conocida: " + encriptado;
    }
