...
public class Principal
{
      public static void main (String[] args)
      {
          ...
          s2 = new TreeSet();  // Un TreeSet es un conjunto ordenado, sin repetici�n de valores
           ...
           System.out.println(" \n\nConjunto ordenado de n�meros");
           System.out.println(s2);
  
           SortedSet start =  s1.headSet(new Persona("Horacio"));
           System.out.println("\n\nConjunto ordenado con los menores que una persona espec�fica: ");
           ...
           System.out.println("\n\nUn conjunto ordenado de n�meros");
           ...
           v.add(0, new Persona("Ana"));  // pedimos insertarlo en la posici�n cero del Vector
           v.add(new Persona("Fede"));
           v.add(new Persona("Conrado"));
           v.add(1, new Persona("Noem�")); // pedimos insertarlo en la posici�n 1
