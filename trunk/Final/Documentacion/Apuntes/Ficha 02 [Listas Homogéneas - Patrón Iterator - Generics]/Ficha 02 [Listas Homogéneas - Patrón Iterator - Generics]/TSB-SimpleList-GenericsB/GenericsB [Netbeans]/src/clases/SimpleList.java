 ...
 *  homogeneidad mediante generics, y tambi�n provee m�todos para facilitar su recorrido externo a modo de implementaci�n liviana del 
 *  patr�n Iterator.
...
public class SimpleList < E extends Comparable >
{
       ...
       *  no es null. Se supone que la lista est� ya ordenada (es decir, se supone que todas las inserciones fueron realizadas llamando a
