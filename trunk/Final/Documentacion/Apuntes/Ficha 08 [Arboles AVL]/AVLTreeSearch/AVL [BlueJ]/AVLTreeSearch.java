...
{
    private boolean h;   // usada como auxiliar en algunos métodos recursivos
    ...
    */
    public boolean add (Comparable x)
    {
      if (x != null)
      {
          // controlamos que la inserción sea homogénea
    ...
    public boolean remove(Comparable x)
    {
      if (x != null)
      {
          // controlamos que la operación sea homogénea
          if (getRaiz() != null && x.getClass() != getRaiz().getInfo().getClass()) return false;
    ...
    private NodeTree insAvl (NodeTree p, Comparable x)
    {
      ...
      if (p == null) 
      {
        ...
        h = true;  // la altura del subarbol creció
      }
      else
      {
