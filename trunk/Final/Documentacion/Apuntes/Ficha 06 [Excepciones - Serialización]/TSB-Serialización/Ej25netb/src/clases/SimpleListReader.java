 ...
 *  la clase SimpleList que haya sido grabado por Serializaci�n.
...
public class SimpleListReader 
{
       ...
       * se recupera con el nombre tomado como par�metro.
       * @param nom el nombre del archivo a abrir para iniciar la recuperaci�n.
       */
